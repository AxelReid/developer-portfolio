  ...
  return (
    <>
      <span
        ref={animatedBgRef}
        id="animated-bg"
        className="absolute left-0 top-0 -z-[1] rounded-lg bg-black/10 opacity-0 transition-opacity delay-[0.2s] group-hover:opacity-100 group-hover:delay-[0s] dark:bg-white/20"
      />
      {menus.map((menu, i) => (
        <Link
          onMouseEnter={(e) => {
